...
import com.produtos.ArquiteturaHexagonal.core.product.service.AlteraProduto;
...
public class ProductConfig {
    ...
    @Bean
    public IProductAlterUseCase<SaveProductClient, Produto> alterarProdutoUseCase(ProductRepository productRepository){
        return new AlteraProduto(productRepository);
    }
}
